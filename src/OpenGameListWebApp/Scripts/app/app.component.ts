...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img alt="logo" src="/img/logo.svg" /></a>
        </div>
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav">
                ...
                <li *ngIf="!authService.isLoggedIn()" class="right" [class.active]="isActive(['login']) || isActive(['register'])"><a class="login" [routerLink]="['login']">Login / Register</a></li>
                <li *ngIf="authService.isLoggedIn()" class="right"><a class="logout" href="javascript:void(0)" (click)="logout()">Logout</a></li>
